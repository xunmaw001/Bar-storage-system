<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酒吧名称" prop="jiubamingcheng">
          <el-input v-model="ruleForm.jiubamingcheng" 
              placeholder="酒吧名称" clearable  :readonly="ro.jiubamingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酒吧名称" prop="jiubamingcheng">
              <el-input v-model="ruleForm.jiubamingcheng" 
                placeholder="酒吧名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酒吧地址" prop="jiubadizhi">
          <el-input v-model="ruleForm.jiubadizhi" 
              placeholder="酒吧地址" clearable  :readonly="ro.jiubadizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酒吧地址" prop="jiubadizhi">
              <el-input v-model="ruleForm.jiubadizhi" 
                placeholder="酒吧地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="创立日期" prop="chuangliriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chuangliriqi" 
                type="date"
                placeholder="创立日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuangliriqi" label="创立日期" prop="chuangliriqi">
              <el-input v-model="ruleForm.chuangliriqi" 
                placeholder="创立日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.beijingtupian" label="背景图片" prop="beijingtupian">
          <file-upload
          tip="点击上传背景图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.beijingtupian?ruleForm.beijingtupian:''"
          @change="beijingtupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.beijingtupian" label="背景图片" prop="beijingtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.beijingtupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiubamingcheng'){
            this.ruleForm.jiubamingcheng = obj[o];
	    this.ro.jiubamingcheng = true;
            continue;
          }
          if(o=='jiubadizhi'){
            this.ruleForm.jiubadizhi = obj[o];
	    this.ro.jiubadizhi = true;
            continue;
          }
          if(o=='guimo'){
	    ...
	    this.ro.guimo = true;
          ...
          if(o=='chuangliriqi'){
            this.ruleForm.chuangliriqi = obj[o];
	    this.ro.chuangliriqi = true;
            continue;
          }
          if(o=='fuzeren'){
	    ...
	    this.ro.xiangqingjieshao = true;
          ...
          if(o=='beijingtupian'){
            this.ruleForm.beijingtupian = obj[o];
	    this.ro.beijingtupian = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiubaxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiubaxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    beijingtupianUploadChange(fileUrls) {
	this.ruleForm.beijingtupian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
