<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酒水名称" prop="jiushuimingcheng">
          <el-input v-model="ruleForm.jiushuimingcheng" 
              placeholder="酒水名称" clearable  :readonly="ro.jiushuimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酒水名称" prop="jiushuimingcheng">
              <el-input v-model="ruleForm.jiushuimingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酒水数量" prop="jiushuishuliang">
          <el-input v-model="ruleForm.jiushuishuliang" 
              placeholder="酒水数量" clearable  :readonly="ro.jiushuishuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酒水数量" prop="jiushuishuliang">
              <el-input v-model="ruleForm.jiushuishuliang" 
                placeholder="酒水数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    zongjia:{
      get: function () {
        return 1*this.ruleForm.jiushuishuliang*this.ruleForm.jiage
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingzhongliang = true;
          ...
          if(o=='jiushuishuliang'){
            this.ruleForm.jiushuishuliang = obj[o];
	    this.ro.jiushuishuliang = true;
            continue;
          }
          if(o=='jiage'){
        ...
        this.ruleForm.jiushuishuliang = 0
	this.ro.jiushuishuliang = false;
      }
      // 获取用户信息
      this.$http({
    ...
    onSubmit() {
      ...
      if(obj!=null) {
	      obj.jiushuishuliang = obj.jiushuishuliang - this.ruleForm.jiushuishuliang
	      if(obj.jiushuishuliang<0){
		this.$message.error("酒水数量不足");
		return
	      }
	      this.$http({
		  url: `${table}/update`,
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiushuigoumai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiushuigoumaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
